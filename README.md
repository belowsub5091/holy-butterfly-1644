...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/holy-butterfly-1644)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/holy-butterfly-1644
```

A live public deployment of this template is available at [https://holy-butterfly-1644.templates.workers.dev](https://holy-butterfly-1644.templates.workers.dev)
